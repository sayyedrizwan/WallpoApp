...
public class VideoTrimmerUploadActivity extends AppCompatActivity implements OnTrimVideoListener, OnCropVideoListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (mVideoTrimmer != null) {
            ...
            mVideoTrimmer.setOnTrimVideoListener(VideoTrimmerUploadActivity.this);
    ...
    public void onError(String message) {
        ...
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                finish();
                Toast.makeText(VideoTrimmerUploadActivity.this, context.getResources().getString(R.string.errorwhilecroppingvideo), Toast.LENGTH_LONG).show();
            }
        });
    }
